...
export default function Visualization({
  ...
  useEffect(() => {
    ...
    // Update simulation data unconditionally. The PR #22/#23 optimization that
    // skipped this on non-structural commits has been reverted in PR #28 —
    // skipping caused the simulation to cool and freeze during long stretches
    // of non-structural commits at high playback speed.
